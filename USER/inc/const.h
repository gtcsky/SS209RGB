...
#define	RGB_INSIDE								1			//是否包含RGB模式
#define	LCD_INSIDE								1			//是否配置LCD模块
#define	LIGHTEFFECT_INSIDE						1			//是否配置特效模式
...
#define	SOFTWARE_VERSION						"SW:2021-12-14"
...
#define	BATT_DET_PULL_UP_RES					270//1000
...
#define	MAX_ColorTemp							85//56
#define	MIN_ColorTemp							25
...
#endif
#define	DEFAULT_COLOR_TEMP					55//44
...
#if(EEPROM_INSIDE==1)
	#define	AUTO_BACKUP_INTERVAL					6				//6*50ms=300ms
#else
	#define	AUTO_BACKUP_INTERVAL					40				//40*50ms=2s
#endif
...
#define 	RED_POWER_RATING						7.5			//
#define 	GREEN_POWER_RATING					7.5			//
#define 	BLUE_POWER_RATING					7.5			//
#define	CW_POWER_RATING						10.0//
#define	MAX_CW_DUTY							(1.0)
#define	MW_POWER_RATING						10.0
#define	MAX_MW_DUTY							(1.0)

#define	RGBLED_REAL_START_DUTY				4		// RGB LED 实际亮度起步4%
#define	SINGLE_COLOR_START_DUTY				0.01
...
#define 	OVER_TEMPERATURE_VOLT_Lv1			85
#define 	OVER_TEMPERATURE_VOLT_Lv0			75
#define 	NORMAL_TEMPERATURE_VOLT			60
...
typedef struct {
	...
	tActivityEnum vActivityIndex;
	UINT8 aArrowIndex[TypeActivityEnumSize];
	UINT8 aBrightValue[TypeActivityEnumSize];
